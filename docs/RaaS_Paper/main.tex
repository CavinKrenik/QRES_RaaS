...
On reboot, the node deserializes $\Gene_{\text{persist}}$ and resumes from the exact pre-shutdown state. We observe zero convergence degradation after forced reboots in simulation.
...
\textbf{Reproducibility.} All code, datasets, and evaluation scripts are available at \url{https://github.com/CavinKrenik/QRES_RaaS} (v19.0.1, DOI:~10.5281/zenodo.18193905).
